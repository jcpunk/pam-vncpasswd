...
fnal-vncpasswd - Set VNC password for pam_fnal_vncpasswd authentication
...
`~/.config/vnc/fnal_vncpasswd`.  This file is used by *pam_fnal_vncpasswd*(8) for
...
-f _FILE_::
  ...
  `~/.config/vnc/fnal_vncpasswd`.  The directory containing _FILE_ must exist.
...
*pam_fnal_vncpasswd*(8), *crypt*(3), *crypt_gensalt_ra*(3), *login.defs*(5)
